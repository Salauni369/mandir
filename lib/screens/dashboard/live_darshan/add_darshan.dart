...
// class _AddDarshanPageState extends State<AddDarshanPage> {
//
//   // 🔥 SINGLE CONTROLLER (NO DUPLICATE)
//   final DarshanController controller = Get.find<DarshanController>();
//
//   final formKey = GlobalKey<FormState>();
//
//   final titleCtrl = TextEditingController();
...
//               }
//
//               // final success = await controller.addDarshan(
//               //   title: titleCtrl.text.trim(),
//               //   embeddedLink: linkCtrl.text.trim(),
//               //   mobile_image: mobile_image.value!, // ✅ CORRECT PARAM
//               // );
//               final success = await controller.addDarshan(
//                 title: titleCtrl.text.trim(),
//                 embeddedLink: linkCtrl.text.trim(),
//                 mobile_imageUrl: mobile_image.value!, // ✅ correct param
//               );
//
//
//
