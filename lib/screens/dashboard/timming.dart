...
class TimingTab extends StatelessWidget {
  ...
  Widget _timingCard(ManageController controller, TimingModel t, bool isAarti) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // TIME FIELDS + DELETE BUTTON IN ONE ROW
          Row(
            children: [
              Expanded(
                child: _timeField(startCtrl, (v) => t.startTime = v),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _timeField(endCtrl, (v) => t.endTime = v),
              ),
              const SizedBox(width: 8),
              // DELETE BUTTON
              Container(
                ...
                child: IconButton(
                  ...
                  icon: Icon(Icons.delete_forever, color: Colors.red.shade600, size: 22),
  ...
  Widget _timeField(TextEditingController ctrl, Function(String) onTimePicked) {
    return TextField(
      readOnly: true,
      controller: ctrl,
      style: const TextStyle(fontSize: 12),
